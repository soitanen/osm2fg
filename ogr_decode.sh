...
######## MOTORWAY #############################################
	...
	$tg/ogr-decode --max-segment 400 --area-type 1x4_road --line-width 18 --where "LANES='4'" --texture-lines $PWD/work/osm_motorway $PWD/data/shapefiles/osm_motorway
	echo $(date) Decoding osm_motorway 3 lanes
	$tg/ogr-decode --max-segment 400 --area-type 1x3_road --line-width 14 --where "LANES='3'" --texture-lines $PWD/work/osm_motorway $PWD/data/shapefiles/osm_motorway
...
############# TRUNK ###########################################
	...
	$tg/ogr-decode --max-segment 500 --area-type 2x4_road --line-width 18 --where "LANES='4' AND ONEWAY!='yes'" --texture-lines $PWD/work/osm_trunk $PWD/data/shapefiles/osm_trunk
	echo $(date) Decoding osm_trunk 4 lanes one-way
	$tg/ogr-decode --max-segment 500 --area-type 1x4_road --line-width 18 --where "LANES='4' AND ONEWAY='yes'" --texture-lines $PWD/work/osm_trunk $PWD/data/shapefiles/osm_trunk
	echo $(date) Decoding osm_trunk 2 lanes
	$tg/ogr-decode --max-segment 500 --area-type 2x2_road --line-width 12 --where "LANES='2'" --texture-lines $PWD/work/osm_trunk $PWD/data/shapefiles/osm_trunk
	echo $(date) Decoding osm_trunk 3 lanes
	$tg/ogr-decode --max-segment 500 --area-type 1x3_road --line-width 15 --where "LANES='3'" --texture-lines $PWD/work/osm_trunk $PWD/data/shapefiles/osm_trunk
...
###############################################################
	...
	echo $(date) Decoding osm_primary
	$tg/ogr-decode --max-segment 500 --area-type 1x4_road --line-width 18 --where "LANES='4' AND ONEWAY='yes'" --texture-lines $PWD/work/osm_primary $PWD/data/shapefiles/osm_primary
	echo $(date) Decoding osm_primary
	$tg/ogr-decode --max-segment 500 --area-type 2x2_road --line-width 12 --where "LANES='2'" --texture-lines $PWD/work/osm_primary $PWD/data/shapefiles/osm_primary
	echo $(date) Decoding osm_primary
	$tg/ogr-decode --max-segment 500 --area-type 1x3_road --line-width 15 --where "LANES='3'" --texture-lines $PWD/work/osm_primary $PWD/data/shapefiles/osm_primary
	echo $(date) Decoding osm_primary
	$tg/ogr-decode --max-segment 500 --area-type 1x1_road --line-width 8 --where "LANES='1'" --texture-lines $PWD/work/osm_primary $PWD/data/shapefiles/osm_primary
	echo $(date) Decoding osm_primary
...
########## LINKS #############
	...
	$tg/ogr-decode --max-segment 500 --area-type 1x4_road --line-width 16 --where "LANES='4' AND ONEWAY='yes'" --texture-lines $PWD/work/osm_motorway_link $PWD/data/shapefiles/osm_motorway_link
	echo $(date) Decoding osm_links 4 lanes two-way
	$tg/ogr-decode --max-segment 500 --area-type 2x4_road --line-width 16 --where "LANES='4' AND ONEWAY!='yes'" --texture-lines $PWD/work/osm_motorway_link $PWD/data/shapefiles/osm_motorway_link
	echo $(date) Decoding osm_links 3 lanes
	$tg/ogr-decode --max-segment 500 --area-type 1x3_road --line-width 12 --where "LANES='3'" --texture-lines $PWD/work/osm_motorway_link $PWD/data/shapefiles/osm_motorway_link
	echo $(date) Decoding osm_links 2 lanes
	$tg/ogr-decode --max-segment 500 --area-type 2x2_road --line-width 10 --where "LANES='2'" --texture-lines $PWD/work/osm_motorway_link $PWD/data/shapefiles/osm_motorway_link
...
########## SECONDARY ############
	...
	$tg/ogr-decode --max-segment 500 --area-type 2x4_road --line-width 16 --where "LANES='4' AND ONEWAY!='yes'" --texture-lines $PWD/work/osm_secondary $PWD/data/shapefiles/osm_secondary
	echo $(date) Decoding osm_secondary
	$tg/ogr-decode --max-segment 500 --area-type 1x4_road --line-width 16 --where "LANES='4' AND ONEWAY='yes'" --texture-lines $PWD/work/osm_secondary $PWD/data/shapefiles/osm_secondary
	echo $(date) Decoding osm_secondary
	$tg/ogr-decode --max-segment 500 --area-type 1x3_road --line-width 14 --where "LANES='3'" --texture-lines $PWD/work/osm_secondary $PWD/data/shapefiles/osm_secondary
	echo $(date) Decoding osm_secondary
	$tg/ogr-decode --max-segment 500 --area-type 2x2_road --line-width 10 --where "LANES='2'" --texture-lines $PWD/work/osm_secondary $PWD/data/shapefiles/osm_secondary
	echo $(date) Decoding osm_secondary
...
####### TERTIARY ###################
	...
	$tg/ogr-decode --max-segment 500 --area-type 2x4_road --line-width 16 --where "LANES='4' AND ONEWAY!='yes'" --texture-lines $PWD/work/osm_tertiary $PWD/data/shapefiles/osm_tertiary
	echo $(date) Decoding osm_tertiary
	$tg/ogr-decode --max-segment 500 --area-type 1x4_road --line-width 16 --where "LANES='4' AND ONEWAY='yes'" --texture-lines $PWD/work/osm_tertiary $PWD/data/shapefiles/osm_tertiary
	echo $(date) Decoding osm_tertiary
	$tg/ogr-decode --max-segment 500 --area-type 1x3_road --line-width 14 --where "LANES='3'" --texture-lines $PWD/work/osm_tertiary $PWD/data/shapefiles/osm_tertiary
	echo $(date) Decoding osm_tertiary
	$tg/ogr-decode --max-segment 500 --area-type 2x2_road --line-width 10 --where "LANES='2'" --texture-lines $PWD/work/osm_tertiary $PWD/data/shapefiles/osm_tertiary
	echo $(date) Decoding osm_tertiary
...
####### RESIDENTIAL ###################
	...
	$tg/ogr-decode --max-segment 500 --area-type 2x4_road --line-width 14 --where "LANES='4' AND ONEWAY!='yes'" --texture-lines $PWD/work/osm_residential $PWD/data/shapefiles/osm_residential
	echo $(date) Decoding osm_residential
	$tg/ogr-decode --max-segment 500 --area-type 1x4_road --line-width 14 --where "LANES='4' AND ONEWAY='yes'" --texture-lines $PWD/work/osm_residential $PWD/data/shapefiles/osm_residential
	echo $(date) Decoding osm_residential
	$tg/ogr-decode --max-segment 500 --area-type 1x3_road --line-width 12 --where "LANES='3'" --texture-lines $PWD/work/osm_residential $PWD/data/shapefiles/osm_residential
	echo $(date) Decoding osm_residential
	$tg/ogr-decode --max-segment 500 --area-type 2x2_road --line-width 8 --where "LANES='2'" --texture-lines $PWD/work/osm_residential $PWD/data/shapefiles/osm_residential
	echo $(date) Decoding osm_residential
...
####### UNCLASSIFIED ###################
	...
	$tg/ogr-decode --max-segment 500 --area-type 2x4_road --line-width 14 --where "LANES='4' AND ONEWAY!='yes'" --texture-lines $PWD/work/osm_unclassified $PWD/data/shapefiles/osm_unclassified
	echo $(date) Decoding osm_unclassified
	$tg/ogr-decode --max-segment 500 --area-type 1x4_road --line-width 14 --where "LANES='4' AND ONEWAY='yes'" --texture-lines $PWD/work/osm_unclassified $PWD/data/shapefiles/osm_unclassified
	echo $(date) Decoding osm_unclassified
	$tg/ogr-decode --max-segment 500 --area-type 1x3_road --line-width 12 --where "LANES='3'" --texture-lines $PWD/work/osm_unclassified $PWD/data/shapefiles/osm_unclassified
	echo $(date) Decoding osm_unclassified
	$tg/ogr-decode --max-segment 500 --area-type 2x2_road --line-width 8 --where "LANES='2'" --texture-lines $PWD/work/osm_unclassified $PWD/data/shapefiles/osm_unclassified
	echo $(date) Decoding osm_unclassified
...
####### SERVICE ###################
	...
	$tg/ogr-decode --max-segment 500 --area-type 1x3_road --line-width 10 --where "LANES='3'" --texture-lines $PWD/work/osm_service $PWD/data/shapefiles/osm_service
	echo $(date) Decoding osm_service
	$tg/ogr-decode --max-segment 500 --area-type 2x2_road --line-width 7 --where "LANES='2'" --texture-lines $PWD/work/osm_service $PWD/data/shapefiles/osm_service
	echo $(date) Decoding osm_service
